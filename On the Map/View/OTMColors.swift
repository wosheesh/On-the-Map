...
struct OTMColors {
    ...
    static let bgDarkOrange = UIColor(red: 0.937, green: 0.455, blue: 0.231, alpha: 1.00)
    static let bgLightOrange = UIColor(red: 0.949, green: 0.592, blue: 0.243, alpha: 1.00)
